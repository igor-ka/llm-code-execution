...
**In this repo, ADRs live in `docs/adr/` as `NNNN-kebab-title.md`** (see `docs/adr/0001-authentication-approach.md`). Continue that sequence; do not introduce a second scheme.
