...
> Follow the `writing-plans` skill for the full task-sizing and ordering mechanics; it is the canonical source in this repo. The template below is a lightweight inline form; if they ever diverge, `writing-plans` takes precedence.
...
Execute tasks one at a time following the `incremental-implementation` and `test-driven-development` skills. Load the spec section and source files relevant to the current task rather than the entire spec.
